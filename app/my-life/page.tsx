...
import { Heart, Music, Camera, Plane, Book, Users, Target, MapPin, Globe, Coffee, LogOut } from "lucide-react"
      ...
      <main className="relative z-10 pt-24 pb-12">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-sm text-white/50 mb-4">Logged in as: {data.user.email}</p>
          ...
          <section className="mb-16">
            <GlassCard variant="default" size="lg" className="text-center">
              ...
              <p className="text-white/80 text-lg leading-relaxed max-w-4xl mx-auto mb-6">
                I'm Karim, a passionate accounting student with a love for diverse cultures and languages. Born into a
                multicultural family, I speak English, Russian, and Arabic fluently, which has given me a unique
                perspective on the world and helped me connect with people from all walks of life.
              </p>
              <p className="text-white/80 text-lg leading-relaxed max-w-4xl mx-auto">
                When I'm not studying for my CPA or working, you'll find me exploring new places, capturing moments
                through photography, or volunteering for causes I care about. I believe in the power of community and
                always strive to give back wherever I can.
              </p>
            </GlassCard>
          </section>
          ...
          <section className="mb-16">
            <div className="text-center mb-10">
              ...
              <p className="text-white/70 text-lg">Things that spark my curiosity and bring joy to my life</p>
            </div>
                  ...
                  >
                    <div className="text-center">
                      <div className="mb-4 flex justify-center">
                        <div
                          className={`p-4 rounded-full bg-gradient-to-br transition-all duration-300 group-hover:scale-110 ${interest.color}`}
                        >
                          <Icon size={32} className="text-white" />
                        </div>
                      </div>
                      <h3 className="text-xl font-semibold mb-3 text-white">{interest.title}</h3>
                      <p className="text-white/70 text-sm leading-relaxed">{interest.description}</p>
                    </div>
                  </GlassCard>
                )
              })}
          ...
          <section className="text-center">
            <GlassCard variant="accent" size="lg">
              <h2 className="text-2xl md:text-3xl font-semibold mb-4 text-white">Let's Connect!</h2>
              <p className="text-white/80 text-lg mb-6 max-w-2xl mx-auto">
                I love meeting new people and learning about different perspectives. Whether you want to chat about
                accounting, travel, languages, or life in general, I'm always open to new conversations and connections.
              </p>
