        ...
        <Tabs defaultValue="about" className="w-full" onValueChange={setActiveTab}>
          ...
          <TabsContent value="about" className="p-4 sm:p-6 space-y-4 sm:space-y-6 focus:outline-none">
            <div className="space-y-3">
              ...
              <p className="text-sm">
                Currently pursuing a BCom in Accounting with a Human Resource Minor at Grant MacEwan University
                (Graduating August). On track for CPA designation. Experienced with Intuit QuickBooks and advanced
                Microsoft Excel for data analytics. Eager to apply my skills in accounting and analytics to diverse
